...
keypoints_raw=importdata('hourglass_flying_result.txt');
keypoints_raw_ref=importdata('hourglass_flying_result_ref.txt');
...
save('flying_auto_keypoint.mat','keypoints');
...
impath='/home/parv/RRC_Dataset/Object_SLAM/flying/left';

str1='possibly new chair';
...
while (i<=size(keypoints_raw,1))
    ...
    disp(current_frame);
	save('flying_auto_keypoint_ref.mat','keypoints_ref');
	i=i+1;
end
